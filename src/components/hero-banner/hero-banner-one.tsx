          ...
          <div className="col-xxl-12">
            <div className="tp-hero-title-wrap mb-35 p-relative">
              ...
              <div className="tp-hero-title-box text-center p-relative">
                ...
                <br/>
                  <span className="tp-hero-title-text">
                    Graphic designer
                  </span>
                </h1>
              </div>
            ...
            <div className="tp-hero-content tp_fade_bottom">
              <p>
              <span>Design is more than looks, it’s how your story comes alive. I create visuals that are simple, smart and unforgettable. Every pixel is crafted with purpose, turning ideas into impact.</span>
