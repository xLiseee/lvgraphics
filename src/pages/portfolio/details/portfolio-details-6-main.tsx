...
// images
import port_d_1 from '@/assets/img/inner-project/portfolio-details/RD1.png';
import port_d_2 from '@/assets/img/inner-project/portfolio-details/RD2.png';
import port_d_3 from '@/assets/img/inner-project/portfolio-details/RD3.png';
                        ...
                        <div className="project-details-1-right-wrap">
                           <div className="project-details-1-right p-relative">
                              <div className="project-details-1-title-box">
                                 <span className="project-details-1-subtitle"><i>06</i>Brand Design</span>
                                 <h4 className="project-details-1-title">RD Tuinen</h4>
                                 <p>Creating different brand assets for RD Tuinen</p>
                              </div>
                           ...
                           <div className="project-details-1-navigation d-flex justify-content-between align-items-center">
                              <a className="project-details-1-prev" href="/portfolio-details-5">
                                 <i className="fa-sharp fa-regular fa-arrow-left"></i>
                              
                              </a>
                              <a href="#">
                              </a>
                              <a className="project-details-1-next" href="/portfolio-details-1">
